...
| Essai de vulgarisation explorable (concepts en codex, parcours de lecture multiples) | Nouveau public ; le non-linéaire sert la pédagogie | Moyen | session 2026-08 | promue → ROADMAP #8 (absorbée par la médiation culturelle) |
...
| Lecture de médiation culturelle pure (non romancée) : un sujet réel du brief — lieu, personnage historique, métier, événement — documenté par recherche agentique sourcée et restitué en lecture explorable | Étend la bibliothèque hors fiction ; nouveau public ; absorbe l'essai de vulgarisation ci-dessus | Élevé — nouvel atelier ; séparation fiction/médiation au catalogue à terme (roadmap Bibliothèque #5) | Pierre, session 2026-08-13 | promue → ROADMAP #8 |
