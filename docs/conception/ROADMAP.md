...
| S2″ | Production | ~~**Pilote à froid de `reportage`**~~ **fait** (2026-08-17, recette v2 : [`livres/la-foret-de-troncais/`](../../livres/la-foret-de-troncais)) — la recette a tenu (aucun défaut au vérificateur) ; les versions v3 à v5 (documents du web, metas v2, modules de lecture) attendent une seconde exécution | aucun prérequis technique |
