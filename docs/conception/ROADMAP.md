...
| S2″ | Production | **Pilote à froid de `reportage` v2** : un brief rempli ([`BRIEF.md`](../../ateliers/reportage/BRIEF.md)) → recherche documentaire sourcée (documents visuels compris) → reportage publié (chantier 8) | aucun prérequis technique |
